...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enque method was trying to insert a person in the first position when it needs to queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Gave an error in the logic that checks for infinite turns. It was only checking for greater than 1 instead of greater than or equal to 1.
